...
//         whileTap={{ scale: 0.95 }}
//         onClick={onToggle}
//         // FIXED: Using a single template literal for the className prop
//         className={`fixed top-4 left-4 z-50 p-3 rounded-xl ${themeClasses.toggleBg} ${themeClasses.border} border backdrop-blur-sm shadow-lg transition-all duration-300 flex items-center space-x-2`}
//       >
//         <motion.div
...
//                         className={`ml-2 p-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 ${
//                           isDarkMode
...
//                         type="button"
//                         onClick={(e) => handleDeleteChat(e, chat.id)}
//                         className="ml-2 px-2 py-1 rounded bg-red-600 text-white text-xs font-semibold hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400"
