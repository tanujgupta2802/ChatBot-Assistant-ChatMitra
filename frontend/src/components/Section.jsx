...
//     setInput(""); // Clear input immediately after adding to messages
//     setIsTyping(true);
...
//         className={`relative flex flex-col w-full max-w-4xl h-[90vh] sm:h-[85vh] ${themeClasses.containerBg} ${themeClasses.border} backdrop-blur-xl rounded-2xl sm:rounded-3xl border shadow-2xl overflow-hidden`}
//       >
...
//         onSelectChat={(chat) => {
//           setMessages([{ role: "user", text: chat.content }]);
//           setConversationHistory([chat]);
//         }}
//         currentChatId={conversationHistory[conversationHistory.length - 1]?.id}
//         chatHistory={conversationHistory}
//         onDeleteChat={(id) => {
//           const filtered = conversationHistory.filter((c) => c.id !== id);
